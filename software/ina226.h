...
#ifndef _SOFTWARE_INA226_H
#define _SOFTWARE_INA226_H

#include "stm32f4xx_hal.h"
#include "stm32f4xx_hal_i2c.h" // 根据芯片型号，自主更改

typedef struct _VolCurrent
{
    float current;
    float voltage;
}VOL_CURRENT_T;
...
#define INA226_CAP_ADDRESS 0x8A
#define INA226_BAT_ADDRESS 0x80
#define CONFIG_WORD 0x484f //0100 0001 0010 0111
#define CALIBRATION_WORD 0x0012
